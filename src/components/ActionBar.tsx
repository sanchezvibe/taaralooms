...
export default function ActionBar({ onAddProduct, searchTerm, onSearchChange }: ActionProps) {
  return (
    <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 mb-4 w-full">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
        ...
        {/* Date Filter */}
        <div className="relative w-full sm:w-auto">
          <select className="appearance-none bg-white py-2 pl-4 pr-10 rounded-md text-sm text-gray-500 w-full focus:outline-none focus:ring-1 focus:ring-gray-300">
